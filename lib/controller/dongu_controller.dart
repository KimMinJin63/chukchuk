...
import 'package:first_project_ver2/service/dongu_service.dart';
import 'package:get/get_state_manager/get_state_manager.dart';
import 'package:get/state_manager.dart';

class DonguController extends GetxController {
  RxList<Restaurant> donguList = RxList<Restaurant>();
  ...
  getRestaurant() async {
    try {
      print('여기는 동구');
      List<Restaurant> donguRestaurant = await DonguService().donguData();
      donguList.assignAll(donguRestaurant);
      print(donguRestaurant.length);
    } catch (e) {
      print('Error DonguController getRestaurant: $e');
    }
  }
  ...
  collectCategory() async {
    ...
    try {
      var result = await DonguService().donguData();
      print('동구 함수 찍힘');
