...
import 'package:first_project_ver2/service/suseongu_service.dart';
import 'package:get/state_manager.dart';

class SuseonguController extends GetxController {
  RxList<Restaurant> suseonguList = RxList<Restaurant>();
  ...
  getRestaurant() async {
    try {
      print('여기는 수성구');
      List<Restaurant> suseonguRestaurant = await SuseonguService().suseonguData();
      suseonguList.assignAll(suseonguRestaurant);
      print(suseonguRestaurant.length);
    } catch (e) {
      print('Error suseonguController getRestaurant: $e');
    }
  }
  ...
  collectCategory() async {
    ...
    try {
      var result = await SuseonguService().suseonguData();
      print('수성구 함수 찍힘');
