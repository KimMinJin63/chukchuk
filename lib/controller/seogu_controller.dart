...
import 'package:first_project_ver2/service/seogu_service.dart';
import 'package:get/state_manager.dart';

class SeoguController extends GetxController {
  RxList<Restaurant> seoguList = RxList<Restaurant>();
  ...
  getRestaurant() async {
    try {
      print('여기는 서구');
      List<Restaurant> seoguRestaurant = await SeoguService().seoguData();
      seoguList.assignAll(seoguRestaurant);
      print(seoguRestaurant.length);
    } catch (e) {
      print('Error SeoguController getRestaurant: $e');
    }
  }
  ...
  collectCategory() async {
    ...
    try {
      var result = await SeoguService().seoguData();
      print('서구 함수 찍힘');
